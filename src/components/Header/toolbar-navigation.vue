    ...
    <div class="row justify-between items-center toolbar-content">
      <div class="row justify-start items-center q-ml-auto">
        <div class="row justify-around items-center q-gutter-sm ">
          <q-btn class="register-btn"><a class="q-mx-md">ثبت نام</a><q-img src="../../assets/RegisterIcon.png" width="24px"></q-img></q-btn>
          <q-btn class="entrance-btn"><a class="q-mx-md">ورود</a><q-img src="../../assets/LoginIcon.png" width="24px"></q-img></q-btn>
      ...
      <q-drawer v-else v-model="sidebarVisible" side="left" show-if-above class="q-py-md" :style="{ width: '200px' }">
        <q-separator class="q-my-xl" color="gray-blue-10" inset />
        <div class="column justify-center items-center sidebar-login-btn-container">
          <q-btn class="register-btn btn-fixed-width"><a class="q-mx-md">ثبت نام</a><q-img src="../../assets/RegisterIcon.png" width="24px"></q-img></q-btn>
          <q-btn class="entrance-btn btn-fixed-width"><a class="q-mx-md">ورود</a><q-img src="../../assets/LoginIcon.png" width="24px"></q-img></q-btn>
        </div>
  ...
  data() {
    ...
    methods: {
      ...
      hasChildItems(itemId){
          return this.InsuranceNavbarMenuItems.filter(item=> item.parentId == itemId).length > 0;
